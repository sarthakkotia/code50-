...
void nnode(tree *node , int val, int *count)
{
    printf("%d ",*count);
    if(node==NULL)
    {
    ...
    nnode(node->left , val , &*count);
    *count++;
    if(*count == val)
    {
        printf("%d ",node->data);
    }
    nnode(node->right , val , &*count);
}
...
int main(void)
{
    ...
    do
    {
        ...
        switch(n)
        {
            ...
            case 4:
                printf("enter the n node to be found : ");
                scanf("%d",&val);
                int count = 0;
                nnode(root , val , &count);
                break;
            case 5:
                inorder(root);
                break;
