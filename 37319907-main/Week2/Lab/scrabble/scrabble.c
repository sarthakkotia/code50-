...
int compute_score(string word)
{
    ...
    // this vvariable to calculate the score and return it
    int score = 0;
    // this variable to calculate the position of the a letter in the alpphabet array and compare it to the points one
    int position = 0;
